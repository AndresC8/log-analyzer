...
# def build_soc_summary(results: Dict[str, Any]) -> str:
#     """
#     Construye un resumen textual de alto nivel a partir del diccionario de resultados
#     que ya generas en run_detections.
...
#         col_targets = "dest_port"  # adapta si usas otro nombre para "targets distintos"
...
#     """
#     Envía el resumen al modelo de OpenAI y devuelve un análisis SOC
#     estructurado para mostrarlo en el dashboard.
#     """
...
#         model="gpt-4.1-mini",  # cambia el modelo si usas otro
#         input=[
